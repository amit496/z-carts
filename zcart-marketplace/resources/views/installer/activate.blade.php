...
@section('container')
    ...
    <form method="post" action="{{ route('Installer.verify') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="email_address" id="email_address" value="{{ old('email_address') }}" placeholder="{{ trans('installer_messages.verify.form.email_address_placeholder') }}" />
        </div>

        <div class="form-group">
            <label for="purchase_code"> {{ trans('installer_messages.verify.form.purchase_code_label') }} </label>
            <input type="text" name="purchase_code" id="purchase_code" value="{{ old('purchase_code') }}" placeholder="{{ trans('installer_messages.verify.form.purchase_code_placeholder') }}" />
        </div>
