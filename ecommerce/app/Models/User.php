...
{
    use HasFactory, SoftDeletes, HasHumanAttributes, Notifiable, Addressable, Imageable, Attachable, ApiAuthTokens;
    ...
    public function smsGateway() {
        return $this->hasOne(\Incevio\Package\SmsGateways\Models\SmsGateway::class);
    }
    ...
    {
        return $this->shop->hasPaymentMethods();
    }
    ...
    /**
     * Seller storefront (zCart {@see owns()} shop as Store).
     */
    public function store()
    {
        return $this->hasOne(Store::class, 'owner_id')->withTrashed()->withDefault();
    }
