...
class Order extends BaseModel
{
    ...
    {
        return $this->belongsTo(Store::class, 'shop_id')->withDefault();
    }
    ...
    /**
     * Admin panel: orders moved to archive ({@see archived_at}).
     */
    ...
    /**
     * Admin panel: active orders (not archive flag).
     */
    ...
    /**
     * Soft-deleted orders only (zCart trash). Use {@see onlyTrashed()} at call sites.
     */
