...
if (!function_exists('is_non_decimal_currency')) {
     ...
     *
     * @param  str $iso value of currencies ISO code
     * @return bool
     */
...
if (!function_exists('get_currency_prefix')) {
    function get_currency_prefix($currency_id = null)
    {
        ...
        if ($currency_id) {
            ...
            return $currency && $currency->symbol_first ? $symbol : '';
...
if (!function_exists('getShippingRates')) {
    ...
    function getShippingRates($zone = null, $cart = null)
    {
        if ($zone) {
            ...
            if (!is_object($cart)) {
                $cart = App\Models\Cart::find($cart); // When cart id is given instead of an cart object
            }

            if (is_incevio_package_loaded('shippo') && isset($cart)) {
...
if (!function_exists('get_featured_vendors')) {
    ...
    {
        if (!$featured_vendors = get_featured_vendor_ids()) {
            return collect([]);
        }
