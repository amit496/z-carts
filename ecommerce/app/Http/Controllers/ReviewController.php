...
class ReviewController extends Controller
{
    ...
    {
        $request->validate(['rating' => 'required|integer|min:1|max:5', 'comment' => 'nullable|string|max:1000', 'order_id' => 'nullable|exists:orders,id']);
        ...
        $review = Review::create([
            ...
            'is_verified' => (bool) $request->order_id,
        ]);
