...
export default function AdminReports({ monthly, totals }) {
    return (
        <AdminLayout title="Sales Reports">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mb-8">
                {[
                    ...
                    { label: 'Customers', value: totals?.customers ?? 0, color: 'bg-purple-500' },
                    { label: 'Products', value: totals?.products ?? 0, color: 'bg-orange-500' },
                ].map(c => (
